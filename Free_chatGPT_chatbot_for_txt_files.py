...
respuesta_bot = obtener_respuesta("aqui va la orden o el rol que debe tomar el chat para procesar la informacion del archivo .txt. Hazlo con la siguiente informacion: ", chat)
